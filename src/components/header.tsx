...
const Header = ({ icon1, icon2, title, subtitle }: HeaderProps) => {
  const textSize = subtitle
    ? "text-2xl sm:text-4xl md:text-6xl mt-2 sm:mt-3 md:mt-4 "
    : "text-3xl sm:text-5xl md:text-7xl";
  return (
    <div className="flex items-center justify-center gap-1 p-4 sm:gap-2 sm:p-6 md:gap-3 md:p-8">
      <Image
        src={icon1}
        alt={title}
        className="size-15 sm:size-20 md:size-30"
      />
