        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute bottom-0 left-5 size-1/7"
              />
            }
          >
          <motion.div whileHover={{ scale: 1.05, transition: { duration: 0.2 } }} whileTap={{ y: 0.2 }} >
            <Image
              src={Return}
              alt="Return Icon"
