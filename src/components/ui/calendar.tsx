  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "flex-1 font-bold text-black py-6 rounded-(--cell-radius) text-[0.8rem] select-none",
        ...
        day: cn(
          "size-(--cell-size) group/day relative aspect-square border-1 border-hohc-grey-200 h-16 w-16 text-center select-none ",
